...
We are now able to reproduce the values, and have attributed these errors to the error in the data file with the mouse traces, as specified by the author.
